...
/*     
 ...
 <div class="fixed {projectOverview ? "w-full" : "w-4/5"} bottom-0 bg-raw-blue  mx-auto border-raw-blue  border-t {hide ? 'hidden' : ''} {showPlaylist ? 'bg-raw-white text-raw-blue bottom-auto max-w-[calc(100%-10rem)] border-y md:border w-full absolute top-14 md:top-10 left-1/2 -translate-x-1/2 mb-4' : ' text-white'}">
